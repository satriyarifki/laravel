                                    ...
                                    <ul class="navbar-nav ms-auto">
                                        ...
                                        @else
                                            <li class="nav-item dropdown" style="width:200px">
                                                <a id="navbarDropdown" class="nav-link dropdown-toggle link-light border border-dark btn-dark" style="padding-left:10px" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                                    {{ Auth::user()->name }}
                                                </a>
